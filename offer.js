...
const Page = {
    ...
    openModalPixeltOffer: (button) => {
        ...
        console.log("🚀 ~ file: offer.js:529 ~ pixelData:", pixelData)
        if (pixelData.length > 0) {
            console.log("🚀 ~ file: offer.js:530 ~ pixelData.length:", pixelData.length)
            $.each(pixelData, (key, pixel) => {
                let pixelId = pixel.id;
                let pixelName = pixel.name;
            });
    ...
    formatSubmitData: () => {
        ...
        $('[id^="pixel-component-"]').each((i, el) => {
            ...
            console.log("🚀 ~ file: offer.js:606 ~ $ ~ idPixel:", idPixel)

            //Input Id
            let InputHiddenPixelId = $(el).find('input[name="pixel_id[]"]').val();
            console.log("🚀 ~ file: offer.js:610 ~ $ ~ InputHiddenPixelId:", InputHiddenPixelId)
            let InputHiddenApiKeyId = $(el).find('input[name="api_id[]"]').val();
            console.log("🚀 ~ file: offer.js:612 ~ $ ~ InputHiddenApiKeyId:", InputHiddenApiKeyId)

            // Text for Input
            let InputTextPixel = $(el).find('input[name="pixel[]"]').val();
            console.log("🚀 ~ file: offer.js:616 ~ $ ~ InputTextPixel:", InputTextPixel)
            let InputTextApi = $(el).find('input[name="api[]"]').val();
            console.log("🚀 ~ file: offer.js:618 ~ $ ~ InputTextApi:", InputTextApi)
            ...
            console.log("🚀 ~ file: offer.js:622 ~ $ ~ InputCheckboxTicket:", InputCheckboxTicket)
            let InputCheckboxPix = $(el).find('input[name="sendPix"]').is(":checked");
            console.log("🚀 ~ file: offer.js:626 ~ $ ~ InputCheckboxPix:", InputCheckboxPix)
            let InputCheckboxCard = $(el)
                .find('input[name="sendCard"]')
                .is(":checked");

            console.log("🚀 ~ file: offer.js:628 ~ $ ~ InputCheckboxCard:", InputCheckboxCard)
            //Input Percentage
            let InputTicketPercentage = $(el).find('input[name="boleto[]"]').val();
            console.log("🚀 ~ file: offer.js:634 ~ $ ~ InputTicketPercentage:", InputTicketPercentage)
            let InputPixPercentage = $(el).find('input[name="pix[]"]').val();
            console.log("🚀 ~ file: offer.js:636 ~ $ ~ InputPixPercentage:", InputPixPercentage)
            let InputCardPercentage = $(el).find('input[name="card[]"]').val();
            console.log("🚀 ~ file: offer.js:638 ~ $ ~ InputCardPercentage:", InputCardPercentage)
            const whatever = $(".btn-add-pixel").data("whatever");
            console.log("🚀 ~ file: offer.js:640 ~ $ ~ whatever:", whatever)
